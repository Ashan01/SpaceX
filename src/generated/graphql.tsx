...
export type LaunchMissionInfoQuery = { __typename?: "Query" } & {
   launch?: Maybe<
      { __typename?: "Launch" } & Pick<Launch, "mission_name" | "launch_year" | "launch_success" | "details"> & {
            launch_site?: Maybe<{ __typename?: "LaunchSite" } & Pick<LaunchSite, "site_name">>;
            rocket?: Maybe<{ __typename?: "LaunchRocket" } & Pick<LaunchRocket, "rocket_name" | "rocket_type">>;
...
export type LaunchesInfoQuery = { __typename?: "Query" } & {
   launches?: Maybe<
      Array<
         Maybe<
            { __typename?: "Launch" } & Pick<Launch, "mission_id" | "mission_name" | "launch_success" | "launch_year">
         >
      >
   >;
};
 ...
 * });
 */
export function useLaunchMissionInfoQuery(
   baseOptions: Apollo.QueryHookOptions<LaunchMissionInfoQuery, LaunchMissionInfoQueryVariables>
) {
   return Apollo.useQuery<LaunchMissionInfoQuery, LaunchMissionInfoQueryVariables>(
      LaunchMissionInfoDocument,
      baseOptions
   );
}
export function useLaunchMissionInfoLazyQuery(
   baseOptions?: Apollo.LazyQueryHookOptions<LaunchMissionInfoQuery, LaunchMissionInfoQueryVariables>
) {
   return Apollo.useLazyQuery<LaunchMissionInfoQuery, LaunchMissionInfoQueryVariables>(
      LaunchMissionInfoDocument,
      baseOptions
   );
}
 ...
 * });
 */
export function useLaunchesInfoQuery(
   baseOptions?: Apollo.QueryHookOptions<LaunchesInfoQuery, LaunchesInfoQueryVariables>
) {
   return Apollo.useQuery<LaunchesInfoQuery, LaunchesInfoQueryVariables>(LaunchesInfoDocument, baseOptions);
}
export function useLaunchesInfoLazyQuery(
   baseOptions?: Apollo.LazyQueryHookOptions<LaunchesInfoQuery, LaunchesInfoQueryVariables>
) {
